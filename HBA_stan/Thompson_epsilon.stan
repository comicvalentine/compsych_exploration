...
transformed parameters{
    ...
    for (h_idx in 1:nH){
        for (s_idx in 1:nS){
            ...
            epsilon[h_idx, s_idx] = Phi_approx(mu_p[h_idx][2] + sigma[h_idx][2]*epsilon_raw[h_idx, s_idx])*0.5; //boundary: (0, 0.5) 
        }
    }
    ...
    for (h_idx in 1:nH) {
        ...
        for (s_idx in 1:nS) {
            ...
            for (bt_idx in 1:nBT) {
                ...
                P_final = (1-epsilon[h_idx, s_idx])*P_n + epsilon[h_idx, s_idx]/3.0;
...
generated quantities{
    ...
    for (h_idx in 1:nH){
        ...
        mu_epsilon[h_idx] = Phi_approx(mu_p[h_idx][2])*0.5;
